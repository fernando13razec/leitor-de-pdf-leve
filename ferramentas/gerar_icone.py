"""Gera o ícone do PDF Leve, usado no programa e nos arquivos PDF.

Folha branca com o canto dobrado e uma faixa vermelha com “PDF” em branco, fácil de achar no
meio de outros arquivos no Explorer e na barra de tarefas.
...
Arquivos gerados:
    recursos/icone.ico      16 a 256 px: embutido no .exe (programa e arquivos PDF) e nas janelas
    recursos/icone.png      256 px: alternativa para as janelas
    recursos/icone-512.png  512 px: README

Nos tamanhos pequenos (até 32 px) o texto é desenhado pixel a pixel, para ficar nítido; nos
maiores, usa uma fonte em negrito do Windows.
"""
...
def principal():
    PASTA_RECURSOS.mkdir(exist_ok=True)
